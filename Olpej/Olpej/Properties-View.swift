extension Property {
    public static func backgroundColor<T: UIView>(color: UIColor) -> Property<T> {
        return Property<T>("uiview.backgroundColor", color.hashValue) { _, mode, view in
            switch(mode) {
    ...
    public static func hidden<T: UIView>(value: Bool) -> Property<T> {
        return Property<T>("uiview.button", value.hashValue) { _, mode, view in
            switch(mode) {
    ...
    public static func alpha<T: UIView>(value: CGFloat) -> Property<T> {
        return Property<T>("uiview.isHidden", value.hashValue) { _, mode, view in
            switch(mode) {
    ...
    public static func frame<T: UIView>(x x: Double, y: Double, width: Double, height: Double) -> Property<T> {
        ...
        return Property<T>("uiview.frame", hashValue) { _, mode, view in
            switch(mode) {
